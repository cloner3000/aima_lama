...
<head>
	<meta charset="utf-8" />
	<link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(URL::asset('img/apple-icon.png')); ?>">
	<link rel="icon" type="image/png" sizes="96x96" href="<?php echo e(URL::asset('img/favicon.png')); ?>">
...
"></i>
	...
	<script src="<?php echo e(URL::asset('js/bootstrap-checkbox-radio.js')); ?>"></script>
