                            ...
                            <div class="deskriptor pull-left">
                                 ...
                                 <div class="row">
                                   <div class="form-group col-md-3">
                                     ...
                                     <input type="number" name="na7_1_1" class="form-control border-input" id="7_1_1_na" min="0" value="{{json_decode($data[0]->data)[0]}}" required>
                                     <small>Jumlah penelitian dnegan biaya luar negeri yang sesuai bidang ilmu</small>
                                   </div>
                                   <div class="form-group col-md-3">
                                     <label for="7_1_1_nb">Nb</label>
                                     <input type="number" name="nb7_1_1" class="form-control border-input" id="7_1_1_nb" min="0" value="{{json_decode($data[0]->data)[1]}}" required>
                                     <small>Jumlah penelitian dengna biaya luar yang sesuai bidang ilmu</small>
                                   </div>
                                   <div class="form-group col-md-3">
                                     <label for="7_1_1_nc">Nc</label>
                                     <input type="number" name="nc7_1_1" class="form-control border-input" id="7_1_1_nc" min="0" value="{{json_decode($data[0]->data)[2]}}" required>
                                     <small>Jumlah penelitian dengna biaya dari PT/sendiri yang sesuai bidang ilmu</small>
                                   </div>
                                   <div class="form-group col-md-3">
                                     <label for="7_1_1_f">F</label>
                                     <input type="number" name="f7_1_1" class="form-control border-input" id="7_1_1_f" min="1" value="{{json_decode($data[0]->data)[3]}}" required>
                            ...
                            <div class="deskriptor pull-left">
                                ...
                                <div class="row">
                                  <div class="form-group col-md-12 form-inline">
                                    ...
                                    <input class="form-control border-input" type="number" name="pd7_1_2" min="0" value="{{json_decode($data[1]->data)[0]}}" required>
                                    <span>%</span>
                            ...
                            <div class="deskriptor pull-left">
                                ...
                                <div class="row">
                                  <div class="form-group col-md-3">
                                    ...
                                    <input type="number" name="na7_1_3" class="form-control border-input" id="7_1_3_na" min="0" value="{{json_decode($data[2]->data)[0]}}" required>
                                    <small>Jumlah penelitian dnegan biaya luar negeri yang sesuai bidang ilmu</small>
                                  </div>
                                  <div class="form-group col-md-3">
                                    <label for="7_1_3_nb">Nb</label>
                                    <input type="number" name="nb7_1_3" class="form-control border-input" id="7_1_3_nb" min="0" value="{{json_decode($data[2]->data)[1]}}" required>
                                    <small>Jumlah penelitian dengna biaya luar yang sesuai bidang ilmu</small>
                                  </div>
                                  <div class="form-group col-md-3">
                                    <label for="7_1_3_nc">Nc</label>
                                    <input type="number" name="nc7_1_3" class="form-control border-input" id="7_1_3_nc" min="0" value="{{json_decode($data[2]->data)[2]}}" required>
                                    <small>Jumlah penelitian dengna biaya dari PT/sendiri yang sesuai bidang ilmu</small>
                                  </div>
                                  <div class="form-group col-md-3">
                                    <label for="7_1_3_f">F</label>
                                    <input type="number" name="f7_1_3" class="form-control border-input" id="7_1_3_f" min="1" value="{{json_decode($data[2]->data)[3]}}" required>
                                    <small>Jumlah dosen tetap yang bidang keahliannya sesuai dengna PS</small>
                                  </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <select name="n7_1_4" id="" class="form-control border-input">
                                        <option value="2" <?php if (json_decode($data[3]->data)[0] == 2) echo "selected" ?>>
                                          Tidak ada karya dosen tetap yang memperoleh HaKI
                                        </option>
                                        <option value="3" <?php if (json_decode($data[3]->data)[0] == 3) echo "selected" ?>>
                                          Satu yang memperoleh HaKI
                                        </option>
                                        <option value="4" <?php if (json_decode($data[3]->data)[0] == 4) echo "selected" ?>>
                            ...
                            <div class="deskriptor pull-left">
                                ...
                                <div class="row">
                                  <div class="form-group col-md-3">
                                    ...
                                    <input type="number" name="na7_2_1" class="form-control border-input" id="7_2_1_na" min="0" value="{{json_decode($data[4]->data)[0]}}" required>
                                    <small>Jumlah kegiatan PkM dengan biaya luar negeri yang sesuai bidang ilmu</small>
                                  </div>
                                  <div class="form-group col-md-3">
                                    <label for="7_2_1_nb">Nb</label>
                                    <input type="number" name="nb7_2_1" class="form-control border-input" id="7_2_1_nb" min="0" value="{{json_decode($data[4]->data)[1]}}" required>
                                    <small>Jumlah kegiatan PkM dengna biaya luar yang sesuai bidang ilmu</small>
                                  </div>
                                  <div class="form-group col-md-3">
                                    <label for="7_2_1_nc">Nc</label>
                                    <input type="number" name="nc7_2_1" class="form-control border-input" id="7_2_1_nc" min="0" value="{{json_decode($data[4]->data)[2]}}" required>
                                    <small>Jumlah kegiatan PkM dengan biaya dari PT/sendiri yang sesuai bidang ilmu</small>
                                  </div>
                                  <div class="form-group col-md-3">
                                    <label for="7_2_1_f">F</label>
                                    <input type="number" name="f7_2_1" class="form-control border-input" id="7_2_1_f" min="1" value="{{json_decode($data[4]->data)[3]}}" required>
