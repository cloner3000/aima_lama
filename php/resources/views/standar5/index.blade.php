                          ...
                          <div class="deskriptor pull-left">
                            ...
                            <div class="row">
                              <div class="form-group col-md-12 form-inline">
                                ...
                                <input class="form-control border-input" type="text" name="pdmk5_1_2_c" value="<?php if(!$dataCheck) echo json_decode($data[2]->data)[0] ?>" required="">
                                <span>%</span>
                          ...
                          <div class="deskriptor pull-left">
                            ...
                            <div class="row">
                              <div class="form-group col-md-12 form-inline">
                                ...
                                <input class="form-control border-input" type="text" name="rmpa5_4_1_a" value="<?php if(!$dataCheck) echo json_decode($data[5]->data)[0] ?>" required="">
                  ...
                  <li class="row">
                      <div class="col-md-12 komponen">
                          ...
                          <div class="deskriptor pull-left">
                            ...
                            <div class="row">
                              <div class="form-group col-md-12 form-inline">
                                <input type="text" name="pp5_4_1_c"class="form-control border-input" id="5_4_1_c_pp" value="<?php if(!$dataCheck) echo json_decode($data[6]->data)[0] ?>" required="">
                                <small>Pertemuan</small>
                              </div>
                            </div>
                  ...
                  <li class="row">
                      ...
                      <div class="col-md-12 komponen">
                          ...
                          <div class="deskriptor pull-left">
                            ...
                            <div class="row">
                              <div class="form-group col-md-12 form-inline">
                                <input type="text" name="rmta5_5_1_b"class="form-control border-input" id="5_5_1_b_rmta" value="<?php if(!$dataCheck) echo json_decode($data[8]->data)[0] ?>" required="">
                                <small>Pertemuan </small>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="col-md-12 komponen">
                          ...
                          <div class="deskriptor pull-left">
                            <div class="row">
                              ...
                              <div class="row">
                                <div class="form-group col-md-12 form-inline">
                                  <input type="text" name="rbta5_5_1_c"class="form-control border-input" id="5_5_1_c_rbta" value="<?php if(!$dataCheck) echo json_decode($data[9]->data)[0] ?>" required="">
                                  <small>Pertemuan </small>
                                </div>
                              </div>
                          </div>
